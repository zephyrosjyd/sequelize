...
describe(Support.getTestDialectTeaser('Hooks'), () => {
  ...
  it('does not expose non-model hooks', function() {
    for (const badHook of ['beforeDefine', 'afterDefine', 'beforeConnect', 'afterConnect', 'beforeInit', 'afterInit', 'beforeBulkSync', 'afterBulkSync', 'beforeDisconnect', 'afterDisconnect']) {
