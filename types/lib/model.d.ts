...
export abstract class Model<T = any, T2 = any> extends Hooks {
   ...
   * The successfull result of the promise will be (instance, initialized) - Make sure to use `const [instance, wasBuilt] = ...`
   */
   ...
   * The successful result of the promise will be (instance, created) - Make sure to use `const [instance, wasCreated] = ...`
   *
