...
const { Association, OneToManyAssociationInstance } = require('./base');
...
class BelongsToMany extends Association {
  ...
  getForInstance(instance) {
    return new OneToManyAssociationInstance(this, instance);
  }
  ...
  async create(sourceInstance, values, options) {
    ...
    await this.add(sourceInstance, newAssociatedObject, _.omit(options, ['fields']));
